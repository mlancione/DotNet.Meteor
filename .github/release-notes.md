...
Disable official .NET Meteor in the VS Code profile using this fork. Download the VSIX for your OS and architecture below and use **Extensions: Install from VSIX**.
